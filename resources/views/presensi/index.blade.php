                                        ...
                                        @foreach ($karyawan as $d)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @elseif($d->status == 'c')
                                                        <span class="badge bg-primary" title="Cuti">C</span>
                                                    @else
                                                        <span class="badge bg-secondary" title="Belum Absen">NA</span>
                                                    @endif
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex items-center justify-content-center gap-2">
                                                        @if ($d->istirahat_in != null)
                                                            @if (!empty($d->foto_istirahat_in))
                                                                @php
                                                                    $path_foto_istirahat_in = Storage::disk('public')->exists(
                                                                        '/uploads/istirahat/' . $d->foto_istirahat_in,
                                                                    )
                                                                        ? url(
                                                                            '/storage/uploads/istirahat/' .
                                                                                $d->foto_istirahat_in,
                                                                        )
                                                                        : asset(
                                                                            'assets/img/avatars/No_Image_Available.jpg',
                                                                        );
                                                                @endphp
                                                                <div class="avatar avatar-xs">
                                                                    <img src="{{ $path_foto_istirahat_in }}" alt=""
                                                                        class="rounded-circle">
                                                                </div>
                                                            @else
                                                                <i class="ti ti-fingerprint"></i>
                                                            @endif
                                                            <a href="#" class="btnShowpresensi_istirahat_in"
                                                                id="{{ $d->id }}" status="istirahat_in">
                                                ...
                                                <td class="text-center">
                                                    <div class="d-flex items-center justify-content-center gap-2">
                                                        @if ($d->istirahat_out != null)
                                                            @if (!empty($d->foto_istirahat_out))
                                                                @php
                                                                    $path_foto_istirahat_out = Storage::disk('public')->exists(
                                                                        '/uploads/istirahat/' . $d->foto_istirahat_out,
                                                                    )
                                                                        ? url(
                                                                            '/storage/uploads/istirahat/' .
                                                                                $d->foto_istirahat_out,
                                                                        )
                                                                        : asset(
                                                                            'assets/img/avatars/No_Image_Available.jpg',
                                                                        );
                                                                @endphp
                                                                <div class="avatar avatar-xs">
                                                                    <img src="{{ $path_foto_istirahat_out }}" alt=""
                                                                        class="rounded-circle">
                                                                </div>
                                                            @else
                                                                <i class="ti ti-fingerprint"></i>
                                                            @endif
                                                            <a href="#" class="btnShowpresensi_istirahat_out"
                                                                id="{{ $d->id }}" status="istirahat_out">
                                                                <span class="font-weight-bold">
...
@push('myscript')
    <script>
        $(function () {
            ...
            $(".btnShowpresensi_in, .btnShowpresensi_out, .btnShowpresensi_istirahat_in, .btnShowpresensi_istirahat_out")
                .click(function(e) {
                e.preventDefault();
