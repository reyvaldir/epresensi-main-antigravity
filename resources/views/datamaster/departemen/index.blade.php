                           ...
                           <thead class="table-dark">
                              <tr>
                                 <th class="text-center align-middle">
                                    <a href="{{ request()->fullUrlWithQuery(['sort' => 'kode_dept', 'order' => request('sort') == 'kode_dept' && request('order') == 'asc' ? 'desc' : 'asc']) }}"
                                       class="text-white text-decoration-none">
                                       KODE DEPARTEMEN
                                       @if(request('sort') == 'kode_dept') <i
                                       class="ti ti-arrow-{{ request('order') == 'asc' ? 'up' : 'down' }}"></i> @endif
                                    </a>
                                 </th>
                                 <th class="text-center align-middle">
                                    <a href="{{ request()->fullUrlWithQuery(['sort' => 'nama_dept', 'order' => request('sort') == 'nama_dept' && request('order') == 'asc' ? 'desc' : 'asc']) }}"
                                       class="text-white text-decoration-none">
                                       NAMA DEPARTEMEN
                                       @if(request('sort') == 'nama_dept') <i
                                       class="ti ti-arrow-{{ request('order') == 'asc' ? 'up' : 'down' }}"></i> @endif
                                    </a>
                                 </th>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="d-flex">
                                          @can('departemen.edit')
                                             <div>
                                                <a href="#" class="me-2 btnEdit" kode_dept="{{ Crypt::encrypt($d->kode_dept) }}">
