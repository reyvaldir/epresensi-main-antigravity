                                    ...
                                    <thead class="table-dark">
                                        <tr>
                                            <th class="text-center align-middle">
                                                <a href="{{ request()->fullUrlWithQuery(['sort' => 'kode_jabatan', 'order' => request('sort') == 'kode_jabatan' && request('order') == 'asc' ? 'desc' : 'asc']) }}"
                                                    class="text-white text-decoration-none">
                                                    KODE JABATAN
                                                    @if(request('sort') == 'kode_jabatan') <i
                                                        class="ti ti-arrow-{{ request('order') == 'asc' ? 'up' : 'down' }}"></i>
                                                    @endif
                                                </a>
                                            </th>
                                            <th class="text-center align-middle">
                                                <a href="{{ request()->fullUrlWithQuery(['sort' => 'nama_jabatan', 'order' => request('sort') == 'nama_jabatan' && request('order') == 'asc' ? 'desc' : 'asc']) }}"
                                                    class="text-white text-decoration-none">
                                                    NAMA JABATAN
                                                    @if(request('sort') == 'nama_jabatan') <i
                                                        class="ti ti-arrow-{{ request('order') == 'asc' ? 'up' : 'down' }}"></i>
                                                    @endif
                                                </a>
                                            </th>
