...
<body class="min-h-screen flex items-center justify-center p-4 bg-slate-50 relative overflow-hidden">
    ...
    <div class="fixed top-0 left-0 w-full h-full pointer-events-none overflow-hidden -z-10">
        <div class="absolute top-[20%] left-[20%] w-72 h-72 bg-blue-400/20 rounded-full blur-3xl mix-blend-multiply animate-blob"></div>
        <div class="absolute top-[20%] right-[20%] w-72 h-72 bg-indigo-400/20 rounded-full blur-3xl mix-blend-multiply animate-blob animation-delay-2000"></div>
        <div class="absolute -bottom-8 left-[40%] w-72 h-72 bg-purple-400/20 rounded-full blur-3xl mix-blend-multiply animate-blob animation-delay-4000"></div>
    </div>

    <!-- Main Card -->
    <div class="w-full max-w-sm bg-white rounded-[2rem] shadow-2xl shadow-slate-200/50 p-8 text-center relative z-10 border border-slate-100">
        ...
        <div class="mb-6 animate-float flex justify-center">
             <div class="relative w-32 h-32 flex items-center justify-center bg-blue-50 rounded-full">
                ...
                <!-- Status Badge -->
                <div class="absolute -right-2 -bottom-2 bg-red-500 text-white rounded-xl p-2 shadow-lg border-4 border-white">
