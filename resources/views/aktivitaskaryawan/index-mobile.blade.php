    ...
    <!-- Header -->
        ...
        <div class="space-y-3 pb-24">
            @foreach ($aktivitas as $d)
                ...
                <div onclick="showDetailActivity(this)" 
                     data-detail="{{ json_encode($d) }}"
                     data-date="{{ $d->tanggal_indo }}"
                     data-time="{{ $jam }}"
                    ...
                    <div class="flex items-start gap-4 pr-10">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                <span class="px-2 py-0.5 rounded-full bg-slate-100 text-slate-500 text-[10px] font-bold border border-slate-200">
                                    {{ $jam }}
                                </span>
                            </div>
            ...
            @if ($aktivitas->isEmpty())
                <div class="text-center py-12">
                    ...
                    <p class="text-slate-500 text-sm mt-1 max-w-[200px] mx-auto">Aktivitas harian yang Anda input akan muncul di sini.</p>
                </div>
            @endif
