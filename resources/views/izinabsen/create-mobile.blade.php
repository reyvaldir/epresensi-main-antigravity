...
@section('content')
    ...
    <div class="flex items-center justify-between mb-5 mt-2">
        <div class="flex items-center gap-3">
            ...
            <h1 class="text-xl font-bold text-slate-800">Buat Izin Absen</h1>
        </div>
    </div>

    <!-- Form Container -->
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-slate-100 mb-6">
        <form action="{{ route('izinabsen.store') }}" method="POST" id="formIzin" autocomplete="off" class="space-y-5">
            @csrf
            ...
            <div class="space-y-1">
                ...
                <div class="relative group">
                    ...
                    <textarea name="keterangan"
                        ...
                        placeholder="Jelaskan alasan izin / keperluan..."></textarea>
                </div>
            </div>
    ...
    <!-- Info Alert if Limit Enabled -->
    @if($general_setting->batasi_hari_izin == 1)
        <div class="mb-6 bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3 shadow-sm">
            ...
            <div>
                <h4 class="font-bold text-blue-700 text-sm mb-1">Informasi Izin</h4>
                <p class="text-xs text-blue-600 leading-relaxed">
                    Maksimal pengajuan izin absen adalah <b>{{ $general_setting->jml_hari_izin_max }} hari</b> per pengajuan.
                </p>
            </div>
        </div>
    @endif
    ...
    <script>
        ...
        $("#formIzin").submit(function (e) {
            ...
            if (dari == "" || sampai == "") {
                ...
                return false;
            } else if (parseInt(jml_hari) > parseInt(jml_hari_izin_max) && batasi_hari_izin == 1) {
                Swal.fire({
                    title: "Oops!",
                    text: 'Maksimal izin absen adalah ' + jml_hari_izin_max + ' hari!',
                    icon: "warning",
