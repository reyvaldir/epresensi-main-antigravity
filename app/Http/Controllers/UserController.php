...
class UserController extends Controller
{
    public function index(Request $request)
    {
        $users = User::query()
            ->with('roles')
            // PENTING: Mengambil semua kolom users dan secara eksplisit mengambil 'nik'
            // dari tabel users_karyawan (hasil dari leftjoin).
            ...
            // Menggunakan leftJoin agar user yang tidak memiliki data karyawan (manual) tetap tampil
